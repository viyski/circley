...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.framework.widget.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.framework.widget.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.framework.widget.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.framework.widget.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
