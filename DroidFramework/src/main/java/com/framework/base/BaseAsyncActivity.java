...
import com.framework.swipeback.SwipeBackActivity;
import com.framework.widget.SwipeBackLayout;

/**
 * Created by sunfusheng on 15/11/5.
 */
public class BaseAsyncActivity<T extends BaseControl> extends SwipeBackActivity implements IRefreshBack {
