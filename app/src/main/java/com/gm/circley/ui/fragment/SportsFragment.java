 ...
 */
public class SportsFragment extends BaseListFragment<NewsEntity> {
    ...
    protected void onRefreshStart() {
        mControl.getNewsListData(UrlParams.CHANNEL_NEWS_SPORTS);
    }

    @Override
    protected void onScrollLast() {
        mControl.getNewsListDataMore(UrlParams.CHANNEL_NEWS_SPORTS,++currentPage);
    }
