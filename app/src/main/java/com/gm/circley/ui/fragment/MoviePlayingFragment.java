 ...
 */
public class MoviePlayingFragment extends BaseListFragment<MovieEntity> {
    ...
    protected void onRefreshStart() {
        mControl.getMovieList(mContext, UrlParams.MOVIE_IN_THEATERS);
    }

    @Override
    protected void onScrollLast() {
        mControl.getMovieMoreList(mContext, UrlParams.MOVIE_IN_THEATERS, mData.size() + 1);
    }
