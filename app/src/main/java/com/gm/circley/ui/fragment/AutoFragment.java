 ...
 */
public class AutoFragment extends BaseListFragment<NewsEntity>{
    ...
    protected void onRefreshStart() {
        mControl.getNewsListData(UrlParams.CHANNEL_NEWS_AUTO);
    }

    @Override
    protected void onScrollLast() {
        mControl.getNewsListDataMore(UrlParams.CHANNEL_NEWS_AUTO,++currentPage);
    }
