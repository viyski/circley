 ...
 */
public class FinanceFragment extends BaseListFragment<NewsEntity> {
    ...
    protected void onRefreshStart() {
        mControl.getNewsListData(UrlParams.CHANNEL_NEWS_FINANCE);
    }

    @Override
    protected void onScrollLast() {
        mControl.getNewsListDataMore(UrlParams.CHANNEL_NEWS_FINANCE,++currentPage);
    }
