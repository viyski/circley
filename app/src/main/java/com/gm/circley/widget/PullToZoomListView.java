...
public class PullToZoomListView extends ListView {
    ...
    private void initView() {
        ...
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PullToZoomListView);
        mImageId = a.getResourceId(R.styleable.PullToZoomListView_headimage, 0);
        a.recycle();
    ...
    private void initHead() {
        ...
        headerView = inflater.inflate(R.layout.image_bg, null);
        imageView = (ImageView) headerView.findViewById(R.id.image_bg);
